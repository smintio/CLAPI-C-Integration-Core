namespace SmintIo.CLAPI.Consumer.Integration.Core.Target
{
    ...
    public interface ISyncTargetCapabilities
    {
        ...
        /// of this sync target.
        ///
        /// <para>The support flag <see cref="SyncTargetCapabilitiesEnum.MultiLanguageSupportEnum"/> indicating
        ...
        /// supporting. If none of the enumerable features are supported, either return <c>null</c> value, or an
        /// empty list or a list containing only enumeration <c>None</c> as item</returns>
        SyncTargetCapabilitiesEnum[] Capabilities { get; }


        /// <summary>
        /// Indicates whether multi languages are supported by this Digital Asset Management and its sync
